    ...
    <View style={styles.screen}>
      <ScrollView>
        ...
        <View style={styles.showText}>
          ...
          <View style={styles.textSole}><Text>{snap.accountNo}</Text></View>
          <View style={styles.line} />

          <Text style={styles.text}>ชื่อบัญชี :</Text>
          <View style={styles.textSole}><Text>{snap.account}</Text></View>
          <View style={styles.line} />

          <Text style={styles.text}>ธนาคาร :</Text>
          <View style={styles.textSole}><Text>{snap.bank}</Text></View>
          <View style={styles.line} />
          ...
          <TextInput
            style={styles.input}
            placeholder="เพิ่มเวลาที่นี่ ..."
            onChangeText={(pass) => setTime(pass)}
          />
